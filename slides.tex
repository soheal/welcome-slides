...
\begin{center}
	\begin{figure}[t!]
		\includegraphics[width=2cm,height=2.3cm]{figs/bram}
		\hspace{1.6cm}
		\includegraphics[width=2cm,height=2.3cm]{figs/eleni}    
		\\ \hspace{0.3cm} Bram Adams \hspace{1cm} Eleni Constantinou
		\vspace{0.1cm}
		\\ Politechnique Montreal \hspace{0.6cm} Univ. Mons \hspace{0.9cm}
	\end{figure}
\end{center}

\begin{center}
	\begin{figure}[t!]
		\includegraphics[width=2cm,height=2.3cm]{figs/tom}
		\hspace{1.6cm}
		\includegraphics[width=2cm,height=2.3cm]{figs/grex}    
%        \vspace{0.4cm}
  ...
  \begin{columns}[T]
    ...
    \begin{column}{0.45\textwidth}
     \begin{block}{SECOHealth}
       \begin{figure}[t!]
         \begin{center}
           \includegraphics[width=3cm,height=4cm]{figs/secohealth}
         \end{center}
    ...
    \begin{column}{0.45\textwidth}
      \begin{block}{SECO-Assist}
       \begin{figure}[t!]
          \begin{center}
            \includegraphics[width=3cm,height=4cm]{figs/seco-assist}
           \end{center}
...
14:00 - 14:30 &	Joint CHAOSS/SECOHealth discussion session \\
...
\vspace{-0.3cm}
\begin{tiny}
Long papers: 15 minutes (+15 minutes of discussion after two presentations) \\
\vspace{-0.3cm}
Short presentations: 10 minutes (+10 minutes of discussion after two presentations).
\end{tiny}
...
\begin{figure}[t!]
		\includegraphics[width=3cm,height=3.6cm]{figs/kate}
	\end{figure}
\vspace{-0.2cm}
Kate Stewart \\
Linux Foundation \\
